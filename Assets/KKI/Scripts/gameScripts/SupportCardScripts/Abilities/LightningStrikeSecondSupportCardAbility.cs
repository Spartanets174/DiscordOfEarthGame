...
public class LightningStrikeSecondSupportCardAbility : BaseSupportÑardAbility
{
    ...
    {
        base.Start();
        SetCardSelectBehaviour(new SelectCellsBehaviour("Âûáåðèòå îáëàñòü äëÿ íàíåñåíèÿ óäàðà", battleSystem, new Vector2(2, 2),"attack"));
