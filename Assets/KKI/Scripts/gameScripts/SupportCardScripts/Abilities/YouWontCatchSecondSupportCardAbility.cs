...
public class YouWontCatchSecondSupportCardAbility : BaseSupportÑardAbility, ITurnCountable
{
    ...
    private void OnSelectCharacter()
    {
        ...
        physAmount = (float)(character.Card.physAttack * 0.5);
        magAmount = (float)(character.Card.magAttack * 0.5);
