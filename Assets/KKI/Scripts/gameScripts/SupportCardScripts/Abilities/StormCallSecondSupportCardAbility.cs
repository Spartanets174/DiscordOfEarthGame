...
public class StormCallSecondSupportCardAbility : BaseSupportÑardAbility
{
    ...
    {
        base.Start();
        SetCardSelectBehaviour(new SelectCellsBehaviour("Âûáåðèòå îáëàñòü äëÿ íàíåñåíèÿ óäàðà", battleSystem, new Vector2(7, 3), "attack"));
