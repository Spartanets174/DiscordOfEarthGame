...
*/     /*   for (int i = 0; i < BattleSystem.field.CellsOfFieled.GetLength(0); i++)
        ...
        *//*BattleSystem.endGameInterface.gameObject.SetActive(true);
        ...
        BattleSystem.endGameText.text = $"Увы, {BattleSystem.playerData.Name}, но вы проиграли! Но не отчаивайтесь, за старания мы дарим вам 500 валюты!";*//*
        BattleSystem.playerData.money += 500;*/
        yield break;
    }
}